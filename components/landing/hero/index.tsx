  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden">
      <div className="max-w-4xl mx-auto text-center relative z-20">
        ...
        <h1 className="text-5xl md:text-7xl tracking-tight text-white mb-6 leading-[1.1]">
        ...
        <p className="text-lg md:text-xl text-zinc-400 font-light mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          docs and speaks human with empathy. No robotic replies, just answers.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
          ...
          <button className="h-11 px-8 rounded-full border border-zinc-800 text-zinc-300 text-sm font-medium hover:border-zinc-600 hover:text-white transition-all bg-black/20 backdrop-blur-sm cursor-pointer">
            View demo
          </button>
        </div>
      </div>
      ...
      <div className="absolute inset-x-0 bottom-0 flex justify-center pointer-events-none z-0">
        <div className="w-150 h-75 bg-indigo-500/20 blur-[120px] rounded-full" />
      </div>

      <div className="max-w-3xl mx-auto relative z-10">
        <div className="rounded-2xl p-1 md:p-2 bg-[#0a0a0e] ring-1 ring-white/10 shadow-2xl">
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-zinc-950/30">
              <div className="flex  w-full flex-col  items-start">
                <div className=" flex  max-w-[85%]  gap-3  flex-row">
                  <div className="w-8 h-8 rounded-full  flex items-center justify-center shrink-0 border-white/5 overflow-hidden  ">
                    <Image
                      src="/chatbot.png"
                      alt="Support Agent "
                      width={40}
                  ...
                  <div className="space-y-2">
                    <div className="p-4 rounded-2xl text-sm leading-relaxed bg-white text-zinc-900">
                      Hi there , How can I help you today ?
                    </div>
                    <div className="flex flex-wrap  gap-2  pt-1  ml-1">
                      <span className="px-3 py-1.5  rounded-full  border  border-zinc-700 bg-zinc-800/50 text-xs  font-medium  cursor-default">
                        {" "}
                        FAQ
                      </span>
                      <span className="px-3 py-1.5  rounded-full  border  border-zinc-700 bg-zinc-800/50 text-xs  font-medium  cursor-default">
                ...
                <div className="flex w-full  flex-col  items-start mt-5">
                  <div className="flex  max-w-[85%] gap-3 flex-row">
                    ...
                    <div className="p-4  rounded-2xl  text-sm leading-relaxed shadow-sm bg-white text-zinc-900 rounded-tl-sm">
                      OneMinute Stack is a powerful suite of AI-driven tools
                      designed to enhance customer support experiences. It
                      leverages advanced natural language processing to
                      understand and respond to customer inquiries in a
                      human-like manner.
                    </div>
                  </div>
                </div>
