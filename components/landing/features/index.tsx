...
function Features() {
  return (
    <section id="features" className="py-32  px-6  max-w-6xl  mx-auto">
      <div className="mb-20">
        <h2 className="text-3xl  md:text-5xl font-medium  text-white  tracking-tight mb-5 ">
          Design for trust
        </h2>
    ...
    <div className="group p-8 rounded-3xl border border-white/5 bg-linear-to-b  from-white/3 to-transparent hover:border-white/10 transition-colors">
          ...
          <p className="text-sm text-zinc-400 font-light leading-relaxed">
            Whether you&apos;re professional , quirky , or concise , the AI
            mimics your brand voice perfectly.
          </p>
        </div>
      </div>
    </section>
